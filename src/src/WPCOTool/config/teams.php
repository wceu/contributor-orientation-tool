...
return array(
	...
	'marketing' => array(
		...
		'description'   => esc_html__( 'The Marketing team promotes WordPress to current and future users and contributors. We create and amplify campaigns to support the growth of the WordPress project.', 'contributor-orientation-tool' ),
